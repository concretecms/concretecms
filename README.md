[![Build Status](https://github.com/concrete5/concrete5/workflows/Tests/badge.svg?branch=8.5.x))](https://github.com/concrete5/concrete5/actions?query=branch%3A8.5.x+workflow%3ATests)
