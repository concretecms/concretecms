<? defined('C5_EXECUTE') or die(_("Access Denied.")); ?>
	...
	<a href="javascript:void(0)" <? if ($replaceOnUnload) { ?> onclick="location.href='<?=DIR_REL?>/index.php?cID=<?=$c->getCollectionID()?>'; return true" class="ccm-button-left cancel" <? } else { ?> onclick="ccm_blockWindowClose()" class="ccm-button-left cancel"<? } ?>><span><em class="ccm-button-close"><?=t('Cancel')?></em></span></a>
