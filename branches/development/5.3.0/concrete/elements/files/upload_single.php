...
<a href="<?=REL_DIR_FILES_TOOLS_REQUIRED?>/files/import" class="dialog-launch" dialog-title="<?=t('Add Files')?>" dialog-on-close="if(swfu && swfu.highlight) { ccm_alRefresh(swfu.highlight) }" dialog-modal="false" dialog-width="450" dialog-height="350">More Options</a>
</div>
