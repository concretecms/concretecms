	...
	if (is_object($uo)) {
		...
		if ($_POST['edit']) {
			...
			if ((strlen($username) < USER_USERNAME_MINIMUM) || (strlen($username) > USER_USERNAME_MAXIMUM)) {
				$error[] = 'A username must be between ' . USER_USERNAME_MINIMUM . ' and ' . USER_USERNAME_MAXIMUM . ' characters';
			}
...
if (is_object($uo)) { 
	...
	<div class="ccm-dashboard-inner">
		...
		<tr>
			<td><input type="text" name="uName" autocomplete="off" value="<?=$uName?>" style="width: 100%"></td>
...
<?
	...
	*/ ?>
	...
	<table class="entry-form" border="0" cellspacing="1" cellpadding="0">
	<tr>
		<td class="subheader" width="50%">Username <span class="required">*</span></td>
		<td class="subheader" width="50%">Password <span class="required">*</span></td>
	</tr>
	<tr>
		<td><input type="text" name="uName" autocomplete="off" value="<?=$_POST['uName']?>" style="width: 100%"></td>
	...
	<tr>
		<td><input type="text" name="uEmail" autocomplete="off" value="<?=$_POST['uEmail']?>" style="width: 100%"></td>
