	...
	if ($cp->canAdminPage() && is_object($a)) {
		...
		<script type="text/javascript">
			function ccm_triggerSelectUser(uID, uName) {
				...
				row2innerHTML = '<td valign="top" style="text-align: center"><strong><?php echo t('Read')?></strong></td>';
				row2innerHTML += '<td valign="top" ><input type="checkbox" name="areaRead[]" value="' + rowValue + '"></td>';
				row2innerHTML += '<td><div style="width: 54px; text-align: right"><strong><?php echo t('Write')?></strong></div></td><td><input type="checkbox" name="areaEdit[]" value="' + rowValue + '"></td>';
				row2innerHTML += '<td><div style="width: 54px; text-align: right"><strong><?php echo t('Delete')?></strong></div></td><td><input type="checkbox" name="areaDelete[]" value="' + rowValue + '"></td>';
				row2innerHTML += '<td valign="top" width="100%"><div style="width: 225px">&nbsp;</div></td>';
				row3innerHTML = '<td valign="top"  style="text-align: center"><strong><?php echo t('Add')?></strong></td>';
