...
<form method="post" action="<?php echo MENU_FEEDBACK_URL?>" name="blockForm">
	...
	<?php  $u = new User(); ?>
	<input type="hidden" name="_cID" value="<?php echo $_GET['cID']?>">
	<input type="hidden" name="_uID" value="<?php echo $u->getUserID()?>">
	<input type="hidden" name="_site" value="<?php echo SITE?>">
	<input type="hidden" name="_baseURL" value="<?php echo BASE_URL?>">
...
<?php  require(DIR_FILES_TOOLS_REQUIRED . '/layout/footer.php'); ?>
