...
<?php  foreach($sets as $s) { 
	...
	<div class="ccm-file-set-add-cb">
		<?php echo checkbox('fsID', $s->getFileSetID(), $s->state)?> <?php echo $s->getFileSetName()?>
	</div>
<?php  } 
...
<?php echo $form->checkbox('fsNew', 1)?> <?php echo $form->text('fsNewText', array('style' => 'width: 250px'))?> <?php echo $form->checkbox('fsNewShare', 1, true)?> <?php echo t('Make set public')?>
