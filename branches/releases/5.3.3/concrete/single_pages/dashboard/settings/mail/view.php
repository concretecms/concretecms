...
<?php  } else { ?>
	...
	<table class="entry-form" border="0" cellspacing="1" cellpadding="0">
	<tr>
		<td class="header" width="50%"><?php echo t('Server')?></td>
		<td class="header" width="50%"><?php echo t('Username')?></td>
	</tr>
	<tr>
		<td><?php echo $form->text('MAIL_SEND_METHOD_SMTP_SERVER', Config::get('MAIL_SEND_METHOD_SMTP_SERVER'), array('style' => 'width: 300px'))?></td>
		<td><?php echo $form->text('MAIL_SEND_METHOD_SMTP_USERNAME', Config::get('MAIL_SEND_METHOD_SMTP_USERNAME'),  array('style' => 'width: 300px'))?></td>
	</tr>
	<tr>
		<td class="header" width="50%"><?php echo t('Password')?></td>
		<td class="header" width="50%"><?php echo t('Port (Leave blank for default)')?></td>
	</tr>
	<tr>
		<td><?php echo $form->password('MAIL_SEND_METHOD_SMTP_PASSWORD', Config::get('MAIL_SEND_METHOD_SMTP_PASSWORD'),  array('style' => 'width: 300px'))?></td>
		<td><?php echo $form->text('MAIL_SEND_METHOD_SMTP_PORT', Config::get('MAIL_SEND_METHOD_SMTP_PORT'),  array('style' => 'width: 300px'))?></td>
	</tr>
	</table>
	</div>
