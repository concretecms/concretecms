...
<style type="text/css">@import "<?php echo ASSETS_URL_CSS?>/ccm.filemanager.css";</style>
...
<style type="text/css">@import "<?php echo ASSETS_URL_CSS?>/jquery.rating.css";</style>
<style type="text/css">@import "<?php echo ASSETS_URL_CSS?>/jquery.ui.css";</style>
<style type="text/css">@import "<?php echo ASSETS_URL_CSS?>/ccm.popup_login.css";</style>
...
<script type="text/javascript" src="<?php echo ASSETS_URL_JAVASCRIPT?>/jquery.rating.js"></script>
<script type="text/javascript" src="<?php echo ASSETS_URL_JAVASCRIPT?>/jquery.form.js"></script>
<script type="text/javascript" src="<?php echo ASSETS_URL_JAVASCRIPT?>/ccm.ui.js"></script>
<script type="text/javascript" src="<?php echo ASSETS_URL_JAVASCRIPT?>/ccm.filemanager.js"></script>
<script type="text/javascript" src="<?php echo ASSETS_URL_JAVASCRIPT?>/ccm.themes.js"></script>
<script type="text/javascript" src="<?php echo ASSETS_URL_JAVASCRIPT?>/jquery.ui.js"></script>
...
<script type="text/javascript" src="<?php echo ASSETS_URL_JAVASCRIPT?>/ccm.popup_login.js"></script>
