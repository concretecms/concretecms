...
class AssetTest extends TestCase
{
    public function testPackageAssetURLs()
    {
        ...
        $this->assertMatchesRegularExpression('%^/path/to/server/concrete/css/awesome.css\?ccm_nocache=[A-Fa-f0-9]+$%', $asset1->getAssetURL());
        $this->assertMatchesRegularExpression('%^/path/to/server/packages/testing_package/blocks/testing_block/js/tab.js\?ccm_nocache=[A-Fa-f0-9]+$%', $asset2->getAssetURL());
