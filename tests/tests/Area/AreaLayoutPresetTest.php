...
class AreaLayoutPresetTest extends PageTestCase
{
    ...
    public function testSavedGridPresets()
    {
        ...
        $columns = $presets[0]->getColumns();
        $this->assertEquals('<div class="col-md-4"></div>', (string) $columns[0]->getColumnHtmlObject());
        $this->assertEquals('<div class="col-md-2 offset-md-2"></div>', (string) $columns[1]->getColumnHtmlObject());
        $this->assertEquals('<div class="col-md-6"></div>', (string) $columns[2]->getColumnHtmlObject());
