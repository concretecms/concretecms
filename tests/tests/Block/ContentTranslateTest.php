...
class ContentTranslateTest extends ConcreteDatabaseTestCase {
    ...
    public function contentsTo()
    {
        return array(
           ...
           array('Test<img src="/path/to/server/index.php/download_file/view_inline/1">', 'Test<concrete-picture fID="1" alt="" style="" />'),
           array('<a href="/path/to/server/index.php/download_file/view/1">Test</a>', '<a href="{CCM:FID_DL_1}">Test</a>')
        );
    }
    ...
    public function contentsFromEditMode()
    {
        return array(
            array('Simple', 'Simple'),
            array('<p><a href="http://www.dummyco.com/path/to/server/index.php?cID=50">Test</a></p>', '<p><a href="{CCM:CID_50}">Test</a></p>'),
            array('Test<img src="/path/to/server/index.php/download_file/view_inline/1" alt="Woohoo" style="display: block" />', 'Test<concrete-picture fID="1" alt="Woohoo" style="display: block" />'),
            array('<a href="/path/to/server/index.php/download_file/view/1">Test</a>', '<a href="{CCM:FID_DL_1}">Test</a>')
        );
    }
    ...
    public function contentsFrom()
    {
        return array(
            ...
            array('<p><a href="{CCM:FID_DL_8}">Download File</a></p>', '<p><a href="/path/to/server/index.php/download_file/view/8">Download File</a></p>')
        );
    }
