...
class JobTest extends Base
{
    ...
    public function set_job_status_to_running()
    {
        ...
        $this->assertTrue($job->getStatus() == Job::JOB_STATUS_RUNNING);
    }
    ...
    public function reset_job_to_enabled()
    {
        ...
        $this->assertTrue($job->getStatus() == Job::JOB_STATUS_ENABLED);
    }
    ...
    public function mark_job_as_started()
    {
        ...
        $this->assertEquals($job->getStatus(), Job::JOB_STATUS_ENABLED);

        $job->markStarted();

        $this->assertEquals($job->getStatus(), Job::JOB_STATUS_RUNNING);
    }
