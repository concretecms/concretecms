...
class CssTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testFileCallbackLocator() {
        ...
        $l->setSourceLocator(function($file) use ($dir) {
            return $dir . '/' . $file;
        });
    ...
    public function testFileEnvironmentCallbackLocator() {
        $l = Core::make("helper/css");
        $env = Environment::get();
        $l->setSourceLocator(function($file) use ($env) {
    ...
    public function testLess() {
        ...
        $l->setCompiledOutputPath(dirname(__FILE__) . '/fixtures/cache/css/testing');
        $l->setCompiledRelativePath('/my/web/root/cache/css/testing');
