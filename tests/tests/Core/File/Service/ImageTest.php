...
class ImageTest extends \PHPUnit_Framework_TestCase {
    ...
    public function legacyImageCreateDataProvider()
    {
        return array(
            array(
                400, 96, DIR_BASE . '/concrete/themes/elemental/images/background.png', 400, 300, false
            ),
            array(
                208, 50, DIR_BASE . '/concrete/themes/elemental/images/background.png', 310, 50, false
            ),
            array(
                90, 90, DIR_BASE . '/concrete/themes/elemental/images/background.png', 90, 90, true
            )
        );
    }
    /**
