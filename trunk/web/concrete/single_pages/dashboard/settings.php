...
<? } else if ($this->controller->getTask() == 'set_global') { ?>
...
<h1><span>URL Rewriting</span></h1>

<div class="ccm-dashboard-inner">

<div class="ccm-dashboard-radio"><?=$form->checkbox('URL_REWRITING', 1, $url_rewriting)?> Enable URL Rewriting</div>
...
<div class="ccm-dashboard-description">No database output, no PHP errors.</div>

<div class="ccm-dashboard-radio"><input type="radio" name="debug_level" value="<?=DEBUG_DISPLAY_ERRORS?>" <? if ($debug_level == DEBUG_DISPLAY_ERRORS) { ?> checked <? } ?> /> Development Level 1 </div>
<div class="ccm-dashboard-description">No database output, but PHP errors are displayed.</div>

<div class="ccm-dashboard-radio"><input type="radio" name="debug_level" value="<?=DEBUG_DISPLAY_ERRORS_SQL?>" <? if ($debug_level == DEBUG_DISPLAY_ERRORS_SQL) { ?> checked <? } ?> /> Development Level 2 </div>
<div class="ccm-dashboard-description">Database queries and PHP errors are displayed.</div>
