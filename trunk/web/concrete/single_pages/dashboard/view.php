...
<div id="ccm-module-row1">
	...
	<div class="ccm-module">
		<h1><span><?=$modules[0]->dbhDisplayName?></span></h1>
		<div class="ccm-dashboard-inner"><?=$dh->output($modules[0])?></div>
	</div>
	<? } ?>
	<? if (is_object($modules[1])) { ?>
	<div class="ccm-module">
		<h1><span><?=$modules[1]->dbhDisplayName?></span></h1>
