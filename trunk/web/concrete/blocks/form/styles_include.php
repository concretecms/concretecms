...
.miniSurveyQuestionRow .miniSurveyOptions a.moveUpLink{ display:block; background:url(<?=DIR_REL?>/concrete/images/icons/arrow_up.png) no-repeat center; height:10px; width:16px; }
.miniSurveyQuestionRow .miniSurveyOptions a.moveDownLink{ display:block; background:url(<?=DIR_REL?>/concrete/images/icons/arrow_down.png) no-repeat center; height:10px; width:16px; }
.miniSurveyQuestionRow .miniSurveyOptions a.moveUpLink:hover{background:url(<?=DIR_REL?>/concrete/images/icons/arrow_up_black.png) no-repeat center;}
.miniSurveyQuestionRow .miniSurveyOptions a.moveDownLink:hover{background:url(<?=DIR_REL?>/concrete/images/icons/arrow_down_black.png) no-repeat center;}
