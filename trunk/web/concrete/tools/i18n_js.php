...
var ccmi18n = { 
	...
	areaLayoutLocked: "<?=t('Layout Locked')?>", 
	deleteLayout: '<?=t('Delete')?>',
	deleteLayoutConfirmMsg: '<?=t('Are you sure that you want to delete this layout section? (provide choice on what to do with blocks?)')?>',
