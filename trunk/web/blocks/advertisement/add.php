...
$controller->ad = new AdvertisementDetails();
$ad = $controller->ad;
$ad->targetImpressions = 1000;
$ad->targetClickThrus = 1000;
?>
<ul id="ccm-ad-tabs" class="ccm-dialog-tabs">
	<li class="ccm-nav-active"><a id="ccm-ad-tab-add" href="javascript:void(0);">New Advertisement</a></li>
	<li class=""><a id="ccm-ad-tab-existing"  href="javascript:void(0);">Select Existing</a></li>
</ul>

<div id="ccm-adPane-add" class="ccm-adPane">
<? include(dirname(__FILE__) . '/ad_form.php');?>
<input type="hidden" id="ccm-ad-source" name="ad_source" value="new" />
<input type="hidden" name="clickThrus" value="0" />
<input type="hidden" name="impressions" value="0" />
</div>

<div id="ccm-adPane-existing" style="display:none" class="ccm-adPane">
<h2>Advertisement Source</h2>
<label><input type="radio" name="existing_source" value="single" class="ccm-ad-sourceSelect" checked="checked"/> Single Advertisement</label>
<label><input type="radio" name="existing_source" value="group" class="ccm-ad-sourceSelect"/> Group of Advertisements</label>
