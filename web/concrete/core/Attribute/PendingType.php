...
class PendingType extends Type {
	...
	public static function getList() {
		...
		$available = array();
		if (is_dir(DIR_BASE . '/' . DIRNAME_ATTRIBUTES . '/' .  DIRNAME_ATTRIBUTE_TYPES)) {
			$contents = $dh->getDirectoryContents(DIR_BASE . '/' . DIRNAME_ATTRIBUTES . '/' .  DIRNAME_ATTRIBUTE_TYPES);
	...
	public static function getByHandle($atHandle) {
		...
		if (file_exists(DIR_BASE . '/' . DIRNAME_ATTRIBUTES . '/' .  DIRNAME_ATTRIBUTE_TYPES . '/' . $atHandle)) {
