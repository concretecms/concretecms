 ...
 */
	...
	class Concrete5_Model_UserInfo extends Object { 
		...
		public function delete(){
			...
			$r = $db->query("DELETE FROM UserRelationships WHERE uID = ?",array(intval($this->uID)) );
			$r = $db->query("DELETE FROM UserRelationships WHERE uRelatedID = ?",array(intval($this->uID)) );
