...
class Concrete5_Model_Page extends Collection {
	...
	**/
	...
	public function rescanSystemPageStatus() {
		...
		$systemPages=array('/login', '/login_oauth', '/register', '/!trash', '/!stacks', '/!drafts', '/account', '/account/*', '/!trash/*', '/!stacks/*', '/!drafts/*', '/download_file', '/profile', '/dashboard', '/profile/*', '/dashboard/*','/page_forbidden','/page_not_found'); 
	...
	public function rescanSystemPages() {
		$db = Loader::db();
		$systemPages=array('/login', '/login_oauth', '/register', '/!trash/%', '/!drafts/%', '/!stacks/%', '/account', '/account/*', '/!trash', '/!stacks', '/!drafts', '/download_file', '/profile', '/dashboard', '/profile/%', '/dashboard/%','/page_forbidden','/page_not_found'); 
		foreach($systemPages as $sp) {
