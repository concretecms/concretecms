...
class Concrete5_Helper_Number {
	...
	* @return string|mixed If $size is not numeric, the function returns $ize (untouched), otherwise it returns the size with the correct usits (GB, MB, ...) and formatted following the locale rules.
