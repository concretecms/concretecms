...
class Concrete5_Controller_LoginOauth extends Controller { 
	...
	public function on_start() {
		...
		$this->openIDReturnTo = BASE_URL . View::url("/login_oauth", "complete_openid"); 
	}
	...
	public function forgot_password() {
		...
		try {
			...
			$changePassURL=BASE_URL . View::url('/login_oauth', 'change_password', $uHash); 		
		...
		if($loginData['success']==1)
			$this->redirect('/login_oauth', 'password_sent');	
	}
