...
class Concrete5_Library_NineSixtyPageThemeGridFramework extends PageThemeGridFramework {
	...
	public function getPageThemeGridFrameworkRowStartHTML() {
		return '<div class="row">';  // dunno if this will apply
	}

	public function getPageThemeGridFrameworkRowEndHTML() {
		return '</div>';  // dunno if this will apply
	}
