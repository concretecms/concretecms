<?=Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Rich Text Editor'));?>
<?php
$h = Loader::helper('concrete/interface');
?>	
<form method="post" id="txt-editor-form" action="<?php  echo $this->url('/dashboard/system/editing/editor', 'txt_editor_config')?>">
