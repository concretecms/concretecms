...
?>
	...
	<div class="controls">
	<label class="radio"><?=$form->radio('MAIL_SEND_METHOD', 'PHP_MAIL', Config::get('concrete.mail.method'))?> <span><?=t('Default PHP Mail Function')?></span></label>
	<label class="radio"><?=$form->radio('MAIL_SEND_METHOD', 'SMTP', Config::get('concrete.mail.method'))?> <span><?=t('External SMTP Server')?></span></label>
	</div>
	</div>
	</fieldset>
