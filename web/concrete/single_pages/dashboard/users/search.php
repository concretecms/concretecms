                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8"><p><span <?php if ($canEditUserName) { ?>data-editable-field-type="xeditable"
                                                       ...
                                                       data-type="text"
                                                       data-name="uName" <?php } ?>><?= $user->getUserName() ?></span></p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-8"><p><span <?php if ($canEditEmail) { ?>data-editable-field-type="xeditable"
                                                       ...
                                                       data-type="email"
                                                       data-name="uEmail"<?php } ?>><?= $user->getUserEmail() ?></span></p>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    if (count($languages) > 0) { ?>
                        <div class="row">
                            ...
                            <div class="col-md-8"><p><span
                                        ...
                                        data-type="select"
                                        data-name="uDefaultLanguage"<?php } ?>><?= $user->getUserDefaultLanguage(); ?></span>
                                </p></div>
                        </div>
                    <?php } ?>
