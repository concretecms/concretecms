...
namespace DoctrineProxies\__CG__\Concrete\Core\File\StorageLocation\Type;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Type extends \Concrete\Core\File\StorageLocation\Type\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'fslTypeHandle', 'fslTypeName', 'fslTypeID', 'pkgID');
        }
    ...
    public function hasOptionsForm()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasOptionsForm', array());
