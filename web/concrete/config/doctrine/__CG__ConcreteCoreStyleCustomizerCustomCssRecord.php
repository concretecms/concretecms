...
namespace DoctrineProxies\__CG__\Concrete\Core\StyleCustomizer;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CustomCssRecord extends \Concrete\Core\StyleCustomizer\CustomCssRecord implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'value', 'sccRecordID');
        }
