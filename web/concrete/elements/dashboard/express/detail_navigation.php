...
<div class="col-md-4">
	<div class="list-group">
		...
		<a class="list-group-item <? if ($c->getCollectionPath() == '/dashboard/express/entities/attributes') { ?>active<? } ?>" href="<?=URL::to('/dashboard/express/entities/associations', $entity->getId())?>"><?=t('Associations')?></a>
