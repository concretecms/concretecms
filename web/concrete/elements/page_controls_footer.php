    ...
    <div id="ccm-toolbar">
        ...
        <ul>
            ...
            <li class="pull-left"><a href="<?= View::url('/dashboard/pages/types') ?>"><i class="fa fa-arrow-left"></i></a>
                ...
                <? if ($c->isEditMode()) { ?>
            <li class="ccm-toolbar-page-edit-mode-active ccm-toolbar-page-edit pull-left hidden-xs"><a
                    data-toolbar-action="check-in" <? if ($vo->isNew()) { ?>href="javascript:void(0)"
                    ...
                    title="<?= t('Exit Edit Mode') ?>"><i class="fa fa-pencil"></i></a></li>
        <? } else { ?>
            <li class="ccm-toolbar-page-edit pull-left hidden-xs"><a data-toolbar-action="check-out"
                                                                     href="<?= DIR_REL ?>/<?= DISPATCHER_FILENAME ?>?cID=<?= $c->getCollectionID() ?>&ctask=check-out<?= $token ?>"
                                                                     title="<?= t('Edit This Page') ?>"><i
                        class="fa fa-pencil"></i></a></li>
        <? } ?>

            <li class="pull-left hidden-xs"><a href="#" data-launch-panel="page"
                                               data-panel-url="<?= URL::to('/ccm/system/panels/page') ?>"
                                               title="<?= t('Page Design, Location, Attributes and Settings') ?>"><i
            ...
            <li class="ccm-toolbar-add pull-left hidden-xs">
                <? if ($c->isEditMode()) { ?>
                    <a href="#" data-launch-panel="add-block" data-panel-url="<?= URL::to('/ccm/system/panels/add') ?>"
                       title="<?= t('Add Content to The Page') ?>"><i class="fa fa-plus"></i></a>
                <? } else { ?>
        ...
        <? } ?>
            <li class="pull-right ccm-toolbar-mobile-menu-button visible-xs hidden-sm hidden-md hidden-lg"><i
                    class="fa fa-bars fa-2"></i></li>
            <li class="pull-right hidden-xs "><a href="<?= URL::to('/dashboard') ?>" data-launch-panel="dashboard"
                                                 title="<?= t('Dashboard – Change Site-wide Settings') ?>"><i
                        class="fa fa-th-large"></i></a>

            <li class="pull-right hidden-xs"><a href="#" data-panel-url="<?= URL::to('/ccm/system/panels/sitemap') ?>"
                                                title="<?= t('Add Pages and Navigate Your Site') ?>"
                                                data-launch-panel="sitemap"><i class="fa fa-list-alt"></i></a>
