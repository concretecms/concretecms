...
<div data-gathering-id="<?=$gathering->getGatheringID()?>" data-gathering-current-page="1" class="<?php if ($showTileControls) { ?>ccm-gathering-edit<?php } else { ?>ccm-gathering-view<?php } ?> ccm-gathering-grid">
