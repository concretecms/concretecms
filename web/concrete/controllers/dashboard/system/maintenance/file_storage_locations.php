...
class DashboardSystemMaintenanceFileStorageLocationsController extends DashboardBaseController {
	...
	public function save(){
		...
		$this->redirect('/dashboard/system/maintenance/file_storage_locations','storage_saved');
	}
