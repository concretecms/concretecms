    ...
    public function getMessageHtml(Message $message)
    {
        ...
        <div class="ccm-notification-help ccm-notification" data-help-notification="{$identifier}">
            ...
            <div class="ccm-notification-actions">
                <a href="#" data-help-notification-identifier="{$identifier}" class="ccm-notification-actions-dismiss-single" data-dismiss="help-single">{$ok}</a><a href="#" data-help-notification-identifier="{$identifier}" data-dismiss="help-all">{$hideAll}</a>
            </div>
        </div>
EOT;
        return $html;
