...
class Version extends Object implements \Concrete\Core\Permission\ObjectInterface
{
    ...
    public function isApproved() {return $this->cvIsApproved;}
    ...
    public function isNew() {return $this->cvIsNew;}
    public function getVersionID() {return $this->cvID;}
    public function getCollectionID() {return $this->cID;}
    public function getVersionName() {return $this->cvName;}
    public function getVersionComments() {return $this->cvComments;}
    ...
    public function getCustomAreaStyles()
    {
        if (!isset($this->customAreaStyles)) {
            $db = Loader::db();
            $r = $db->GetAll('select issID, arHandle from CollectionVersionAreaStyles where cID = ? and cvID = ?', array($this->getCollectionID(), $this->cvID));
    ...
    public function canWrite() {return $this->cvCanWrite;}
