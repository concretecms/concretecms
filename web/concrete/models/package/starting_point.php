...
class StartingPointPackage extends Package {
	...
	public function set_site_permissions() {
		...
		$home->assignPermissions($g3, array('view_page_versions', 'edit_page_properties', 'edit_page_contents', 'edit_page_speed_settings', 'edit_page_design', 'edit_page_permissions', 'delete_page', 'delete_page_versions', 'approve_page_versions', 'add_subpage', 'move_or_copy_page'));
	}
