...
defined('DIR_CONFIG_SITE') or define('DIR_CONFIG_SITE', DIR_BASE . '/config');
defined('CONFIG_FILE') or define('CONFIG_FILE', DIR_CONFIG_SITE . '/site.php');
defined('DIRNAME_APP') or define('DIRNAME_APP', 'concrete');
 ...
 * have a DIRNAME_APP_UPDATED constant, which lives in that file, and which 
 * points to another core. If we have this constant, we exit this file 
 * immeditely and proceed into the updated core.
 * ----------------------------------------------------------------------------
 */
if (defined('DIRNAME_APP_UPDATED') && (!defined('APP_UPDATED_PASSTHRU'))) {
...
define('DIR_FILES_TOOLS', DIR_BASE . '/tools');
 ...
 * ----------------------------------------------------------------------------
 */
defined('DIR_FILES_CACHE') or define('DIR_FILES_CACHE', DIR_BASE . '/files/cache');
defined('FILENAME_ENVIRONMENT_CACHE') or define('FILENAME_ENVIRONMENT_CACHE', 'environment.cache');
defined('DIR_FILES_PAGE_CACHE') or define('DIR_FILES_PAGE_CACHE', DIR_BASE . '/files/cache/pages');
