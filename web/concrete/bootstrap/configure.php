...
defined('FILE_MANAGER_THUMBNAIL_HANDLE') or define('FILE_MANAGER_THUMBNAIL_HANDLE', 'file_manager');
defined('FILE_MANAGER_THUMBNAIL_WIDTH') or define('FILE_MANAGER_THUMBNAIL_WIDTH', '60');
