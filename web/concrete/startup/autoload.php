...
$classes = array(
	...
	'AccessUserSearchUserPermissionKey,AccessUserSearchUserPermissionAssignment,AccessUserSearchUserPermissionAccess,AccessUserSearchUserPermissionAccessListItem' => array('model','permission/keys/access_user_search'),
	'AddBlockBlockTypePermissionKey,AddBlockBlockTypePermissionAssignment,AddBlockBlockTypePermissionAccess,AddBlockBlockTypePermissionAccessListItem' => array('model','permission/keys/add_block'),
	'AddBlockToAreaAreaPermissionKey,AddBlockToAreaAreaPermissionAssignment,AddBlockToAreaAreaPermissionAccess,AddBlockToAreaAreaPermissionAccessListItem' => array('model','permission/keys/add_block_to_area'),
	'AddFileFileSetPermissionKey,AddFileFileSetPermissionAssignment,AddFileFileSetPermissionAccess,AddFileFileSetPermissionAccessListItem' => array('model','permission/keys/add_file'),
	'AddSubpagePagePermissionKey,AddSubpagePagePermissionAssignment,AddSubpagePagePermissionAccess,AddSubpagePagePermissionAccessListItem' => array('model','permission/keys/add_subpage'),
	'AssignUserGroupsUserPermissionKey,AssignUserGroupsUserPermissionAssignment,AssignUserGroupsUserPermissionAccess,AssignUserGroupsUserPermissionAccessListItem' => array('model','permission/keys/assign_user_groups'),
	'EditPagePropertiesPagePermissionKey,EditPagePropertiesPagePermissionAssignment,EditPagePropertiesPagePermissionAccess,EditPagePropertiesPagePermissionAccessListItem' => array('model','permission/keys/edit_page_properties'),
	'EditPageThemePagePermissionKey,EditPageThemePagePermissionAssignment,EditPageThemePagePermissionAccess,EditPageThemePagePermissionAccessListItem' => array('model','permission/keys/edit_page_theme'),
	'EditUserPropertiesUserPermissionKey,EditUserPropertiesUserPermissionAssignment,EditUserPropertiesUserPermissionAccess,EditUserPropertiesUserPermissionAccessListItem' => array('model','permission/keys/edit_user_properties'),
	'ViewUserAttributesUserPermissionKey,ViewUserAttributesUserPermissionAssignment,ViewUserAttributesUserPermissionAccess,ViewUserAttributesUserPermissionAccessListItem' => array('model','permission/keys/view_user_attributes'),
