...
<form method="post" action="<?=$controller->action('submit')?>" data-dialog-form="search-customize">
	...
	<fieldset>
		...
		<ul class="list-unstyled" data-search-column-list="pages">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<select <? if (count($fldc->getSortableColumns()) == 0) { ?>disabled="true"<? } ?> class="form-control" data-search-select-default-column="pages" id="fSearchDefaultSort" name="fSearchDefaultSort">
