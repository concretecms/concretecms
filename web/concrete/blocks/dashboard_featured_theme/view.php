...
<? if (is_object($remoteItem)) { ?>
	...
	<a href="javascript:void(0)" onclick="ccm_getMarketplaceItemDetails(<?=$remoteItem->getMarketplaceItemID()?>)" href="<?=$remoteItem->getRemoteURL()?>" class="btn btn-default"><?=t('Learn More')?></a>
<? } else { ?>
