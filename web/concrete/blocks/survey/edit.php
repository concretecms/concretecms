...
<br/>
<label for="requiresRegistration"><?=t('Open to all site visitors?')?></label>
<div class="radio">
    <label>
    <input id="requiresRegistration" type="radio" value="0" name="requiresRegistration" style="vertical-align: middle" <? if (!$controller->requiresRegistration()) { ?> checked <? } ?> />&nbsp;<?=t('Yes')?>
    </label>
</div>
<div class="radio">
    <label>
