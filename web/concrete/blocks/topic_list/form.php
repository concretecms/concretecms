...
<fieldset>
    <div class="form-group">
        ...
        <select class="form-control" name="mode" id="modeSelect">
            <option value="S" <?php if ($mode == 'S') { ?>selected<?php } ?>><?=t('Search – Display a list of all topics for use on a search sidebar.')?></option>
            <option value="P" <?php if ($mode == 'P') { ?>selected<?php } ?>><?=t('Page – Display a list of topics for the current page.')?></option>
        </select>
    </div>
    ...
    <div class="form-group" data-row="mode-page">
        ...
        <select class="form-control" name="topicAttributeKeyHandle" id="attributeKeySelect">
            <?php foreach($attributeKeys as $attributeKey) { ?>
                <option value="<?=$attributeKey->getAttributeKeyHandle()?>" <?php if ($attributeKey->getAttributeKeyHandle() == $topicAttributeKeyHandle) { ?>selected<?php } ?>><?=$attributeKey->getAttributeKeyDisplayName()?></option>
            <?php } ?>
        </select>
    </div>
