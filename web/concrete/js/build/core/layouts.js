...
(function(global, jQuery) {
    ...
    jQuery.fn.ccmlayout = function (options) {
        return this.each(function () {
            ...
            if (!data) {
                $obj.data('ccmlayout', (data = new Layout(this, options)));
            }
        });
    };
    ...
    // private methods
    Layout.prototype._setupDOM = function () {
        // form list items
    ...
    Layout.prototype._setupFormSaveAndCancel = function () {
        var obj = this;
    ...
    Layout.prototype._rescanAreasInPage = function (e, data) {
        var editor = Concrete.getEditMode();
        editor.reset();
        editor.scanBlocks();
    };

    Layout.prototype._setupToolbarView = function () {
        var obj = this;
    ...
    Layout.prototype._updateChooseTypeForm = function () {
    ...
    Layout.prototype._setupFormEvents = function () {
        var obj = this;
    ...
    Layout.prototype.buildThemeGridGrid = function () {
        this.$element.html('');
    ...
    Layout.prototype._updateThemeGridView = function (presetLoad) {
    ...
    Layout.prototype._buildThemeGridGridFromPresetColumns = function (arLayoutColumns) {
        this.$element.html('');
        var obj = this;
        var row = this.options.rowstart;
        row += '<div id="ccm-theme-grid-edit-mode-row-wrapper">';
    ...
    Layout.prototype._updateCustomView = function (presetLoad) {
    ...
    Layout.prototype._resetSlider = function () {
        if (this.$slider) {
    ...
    Layout.prototype._getThemeGridColumnSpan = function (totalColumns) {
    ...
    Layout.prototype._getThemeGridNearestValue = function (value, values) {
        var nearest = null;
        var diff = null;
    ...
    Layout.prototype._showThemeGridSlider = function () {
    ...
    Layout.prototype._redrawThemeGrid = function () {
        var obj = this;
    ...
    Layout.prototype._showCustomSlider = function () {
