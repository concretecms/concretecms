...
(function ($) {
    ...
    */
    $.fn.editableform.template = '<form class="form-stacked editableform">'+
...
(function ($) {
    ...
    DateTimeField.defaults = $.extend({}, $.fn.editabletypes.datetime.defaults, {
        ...
        @property tpl
        **/
        tpl:'<div class="input-append date"><input type="text"/><span class="add-on"><i class="fa-th"></i></span></div>',
        /**
        @property inputclass
