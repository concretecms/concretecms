...
RedactorPlugins.fontcolor = {
    init: function()
    {
        ...
        for (var i = 0; i < 1; i++)
        {
            ...
            var $dropdown = $('<ul class="dropdown-menu redactor_dropdown_box_' + name + '" style="display: none; width: 243px;">');
    ...
    pickerBuild: function($dropdown, name, colors)
    {
        ...
        for (var z = 0; z < len; z++)
        {
            ...
            var $swatch = $('<a rel="' + color + '" data-rule="' + rule +'" href="#" style="float: left; font-size: 0; border: 2px solid #fff; padding: 0; margin: 0; width: 20px; height: 20px;"></li>');
