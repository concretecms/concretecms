		...
		return {
			getTemplate: function()
			{
				...
				+ '<section id="redactor-modal-table-insert">'
					...
					+ '<label class="control-label">' + this.lang.get('rows') + '</label>'
					+ '<input type="text" size="5" value="2" class="form-control" id="redactor-table-rows" />'
					+ '</div>'
					+ '<div class="form-group">'
					+ '<label class="control-label">' + this.lang.get('columns') + '</label>'
					+ '<input type="text" size="5" value="3" class="form-control" id="redactor-table-columns" />'
					+ '</div>'
				+ '</section>';
			},
			init: function()
			{
				...
				/* concrete5 */
				this.button.setAwesome('table', 'fa fa-table');
