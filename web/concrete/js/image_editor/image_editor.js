...
var ImageEditor = function(settings) {
    ...
    im.bindEvent = im.bind = im.on = function(e, t, n) {
        ...
        console.log("Binding", e, data, r);
        ccm_event.sub(e, t, r);
    };
    im.fireEvent = im.fire = im.trigger = function(e, t, n) {
        var r = n || im.stage.getContainer();
        if (r instanceof jQuery) r = r[0];
        console.log("Sending", e, t, r);
        ccm_event.pub(e, t, r);
    };
    im.addElement = function(e, t) {
        ...
        e.doppelganger.setDrawFunc(function(e) {
            if (typeof this._drawFunc == "function") {
                for (var n in this.doppelganger.attrs) {
                    if (n == "drawFunc" || n == "drawHitFunc" || n == "strokeWidth" || n == "fill") continue;
                    this.attrs[n] = this.doppelganger.attrs[n];
                }
    ...
    im.buildBackground = function() {
        ...
        im.totalBackground.setX(t.max.x - t.width);
        im.totalBackground.setY(t.max.y - t.height);
        im.totalBackground.setWidth(n);
        im.totalBackground.setHeight(n);
        if (!im.saveArea) {
