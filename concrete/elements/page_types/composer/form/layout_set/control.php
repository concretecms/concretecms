...
<tr class="ccm-item-set-control" data-page-type-composer-form-layout-control-set-control-id="<?=$control->getPageTypeComposerFormLayoutSetControlID(); ?>">
	...
	<td>
		<span class="text-muted"><?php if ($control->isPageTypeComposerFormLayoutSetControlRequired()) {
    echo t('Required');
} ?></span>
	</td>
	...
	<td style="text-align: right; white-space: nowrap;">
		<ul class="ccm-item-set-controls">
			<li><a href="#" data-command="move-set-control" style="cursor: move"><i class="fa fa-arrows-alt"></i></a></li>
			...
			<li><a href="#" data-delete-set-control="<?=$control->getPageTypeComposerFormLayoutSetControlID(); ?>"><i class="fa fa-trash-alt"></i></a></li>
		</ul>
