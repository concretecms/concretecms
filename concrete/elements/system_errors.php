...
if (isset($error) && $error) {
    ...
    if (count($_error) > 0) {
        ...
        if (isset($format) && $format == 'block') {
            ?>
            <div class="ccm-system-errors alert alert-danger alert-dismissable"><button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                <?php
...
if (isset($message)) {
    ?><div class="alert alert-info"><a data-bs-dismiss="alert" href="#" class="btn-close"></a> <?= $message ?></div><?php
}

if (isset($success)) {
    ?><div class="alert alert-success"><a data-bs-dismiss="alert" href="#" class="btn-close"></a> <?= $success ?></div><?php
}
