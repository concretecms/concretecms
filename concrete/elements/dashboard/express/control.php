...
<tr class="ccm-item-set-item" data-field-set-control="<?=$control->getID()?>">
	...
	<td>
		<ul class="ccm-item-set-controls">
			...
			<li><a data-command="edit-control" href="<?=URL::to('/dashboard/system/express/entities/forms', 'edit_control', $control->getId())?>" dialog-height="auto" dialog-width="600" dialog-title="<?=t('Edit Control')?>" class="dialog-launch"><i class="fa fa-pencil"></i></a></li>
