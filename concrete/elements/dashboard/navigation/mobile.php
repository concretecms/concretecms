    ...
    if (count($items)) { ?>
        <ul class="nav flex-column ccm-mobile-menu">
            <?php foreach($items as $item) {
                ...
                if ($item instanceof \Concrete\Core\Navigation\Item\RenderableItemInterface) { ?>

                    <?=$item->render()?>

                <?php } else if ($item instanceof \Concrete\Core\Navigation\Item\SupportsChildrenItemInterface) { ?>
                    <li
