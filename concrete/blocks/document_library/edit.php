...
/** @var int[] $selectedSets */
/** @var string[] $searchPropertiesSelected */
/** @var string[] $expandablePropertiesSelected */
/** @var string[] $viewPropertiesDoNotDisplay */
/** @var string[] $viewPropertiesDisplay */
/** @var string[] $viewPropertiesDisplaySortable */
/** @var array<string,string> $orderByOptions */
...
/** @var string[] $viewProperties */
/** @var string[] $expandableProperties */
/** @var array<string,string> $searchProperties */
/** @var string|null $orderBy */
/** @var int|null $displayLimit */
/** @var bool|null $displayOrderDesc */
/** @var int|null $addFilesToSetID */
/** @var int|null $maxThumbWidth */
/** @var int|null $maxThumbHeight */
/** @var int|null $enableSearch */
/** @var string|null $heightMode */
/** @var string|null $downloadFileMethod */
/** @var int|null $fixedHeightSize */
/** @var string|null $headerBackgroundColor */
/** @var string|null $headerBackgroundColorActiveSort */
/** @var string|null $headerTextColor */
/** @var int|null $allowFileUploading */
/** @var int|null $allowInPageFileManagement */
/** @var string|null $tableName */
/** @var string|null $tableDescription */
/** @var bool|null $tableStriped */
/** @var string|null $rowBackgroundColorAlternate */
/** @var int|null $hideFolders */
...
<div class="tab-content">
    <div class="tab-pane show active" id="sources" role="tabpanel">
        ...
        <div class="form-group">
            ...
            <div class="text-muted">
                <?php echo t('Note: the above options are dependent on %s.', '<a href="' . Url::to('/dashboard/system/files/permissions') . '">' . t('file permissions') . '</a>') ?>
            </div>
        </div>

        <div class="form-group" data-options="enable-uploads">
            <?php echo $form->label('addFilesToSetID', t('Add Uploaded Files to Set')); ?>
            <?php echo $form->select('addFilesToSetID', $fileSetList, $addFilesToSetID ?? null); ?>
        </div>
    </div>
    ...
    <div class="tab-pane" id="header" role="tabpanel">
        ...
        <div class="form-group">
            ...
            <div class="row row-cols-lg-auto align-items-center">
                <div class="col-auto">
                    <?php echo $form->select('orderBy', $orderByOptions, $orderBy ?? null); ?>
                </div>
                <div class="col-auto">
    ...
    <div class="tab-pane" id="results" role="tabpanel">
        ...
        <div class="form-group">
            ...
            <?php echo $form->text('displayLimit', (string) $displayLimit) ?>
        </div>
        ...
        <div class="form-group" data-options="height-mode">
            ...
            <?php echo $form->text('fixedHeightSize', (string) ($fixedHeightSize ?? '')) ?>
        </div>
        ...
        <fieldset data-options="thumbnail">
            ...
            <div class="form-group">
                ...
                <?php echo $form->text('maxThumbWidth', $maxThumbWidth ?? '') ?>
            </div>

            <div class="form-group">
                <?php echo $form->label('maxThumbHeight', t('Height')) ?>
                <?php echo $form->text('maxThumbHeight', $maxThumbHeight ?? '') ?>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <?php echo $form->radio('tableStriped', 0, $tableStriped ?? null, ['name' => 'tableStriped', 'id' => 'tableStripedOff']) ?>
                    <?php echo $form->label('tableStripedOff', t('Off (all rows the same color)'), ['class' => 'form-check-label']); ?>
                </div>

                <div class="form-check">
                    <?php echo $form->radio('tableStriped', 1, $tableStriped ?? null, ['name' => 'tableStriped', 'id' => 'tableStripedOn']) ?>
