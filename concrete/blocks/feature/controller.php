...
class Controller extends BlockController implements UsesFeatureInterface
{
    ...
    {
        /*
         * Less files are no longer available so we need to provide the list statically.
         * Furthermore we need to include the prefixes because FA5+ is using multple prefixes.
         */
        return [
            'fab fa-500px',
