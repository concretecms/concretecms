...
class BlockTypeManager extends AbstractManager
{
    public function __construct()
    {
        $this->registerMessages(array(
            ...
            'youtube' => array(t('Paste a short or long-form YouTube link into the YouTube URL field and concrete5 will embed the video on your page. Playlist URLs and comma separated lists of video IDs are also supported.'), 'http://documentation.concrete5.org/editors/in-page-editing/block-areas/add-block/youtube-video'),
        ));
    }
