...
class EditPageThemePageAccess extends PageAccess
{
    ...
    public function save($args = [])
    {
        ...
        if (isset($args['pThemeIDInclude']) && is_array($args['pThemeIDInclude'])) {
        ...
        if (isset($args['pThemeIDExclude']) && is_array($args['pThemeIDExclude'])) {
     ...
     *
     * @return \Concrete\Core\Permission\Access\ListItem\EditPageThemePageListItem[]
     */
    public function getAccessListItems($accessType = PagePermissionKey::ACCESS_TYPE_INCLUDE, $filterEntities = [], $checkCache = true)
    {
        $db = Database::connection();
        /** @var \Concrete\Core\Permission\Access\ListItem\EditPageThemePageListItem[] $list */
