...
/**
 * @method \Concrete\Core\Permission\Access\ListItem\NotifyInNotificationCenterNotificationListItem[] getAccessListItems($accessType = self::ACCESS_TYPE_INCLUDE, $filterEntities = [], $checkCache = true)
 */
