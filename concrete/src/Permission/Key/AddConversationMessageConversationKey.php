...
/**
 * @method \Concrete\Core\Permission\Access\ListItem\AddConversationMessageConversationListItem[] getAccessListItems($accessType = self::ACCESS_TYPE_INCLUDE, $filterEntities = [], $checkCache = true)
 */
