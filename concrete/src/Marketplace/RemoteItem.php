...
class RemoteItem extends ConcreteObject
{
    ...
    public function enableFreeLicense()
    {
        ...
        $url = Config::get('concrete.urls.concrete5_secure') . Config::get('concrete.urls.paths.marketplace.item_free_license');
    ...
    protected static function getRemotePackageObject($method, $identifier)
    {
        ...
        $url = Config::get('concrete.urls.concrete5_secure') . Config::get('concrete.urls.paths.marketplace.item_information');
