...
class StartingPointPackage extends BasePackage
{
    ...
    public function __construct(Application $app)
    {
        ...
        $this->routines = [
            ...
            new StartingPointInstallRoutine('install_database', 6, t('Creating database tables.')),
            new StartingPointInstallRoutine('install_site', 19, t('Creating site.')),
            new StartingPointInstallRoutine('add_users', 20, t('Adding admin user.')),
            new StartingPointInstallRoutine('install_permissions', 21, t('Installing permissions & workflow.')),
            ...
            new StartingPointInstallRoutine('install_jobs', 68, t('Installing automated jobs.')),
            new StartingPointInstallRoutine('install_dashboard', 69, t('Installing dashboard.')),
            new StartingPointInstallRoutine('install_required_single_pages', 78, t('Installing login and registration pages.')),
            new StartingPointInstallRoutine('install_image_editor', 79, t('Adding image editor functionality.')),
            new StartingPointInstallRoutine('install_config', 80, t('Configuring site.')),
            new StartingPointInstallRoutine('import_files', 81, t('Importing files.')),
            new StartingPointInstallRoutine('install_content', 82, t('Adding pages and content.')),
