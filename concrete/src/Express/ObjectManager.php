...
class ObjectManager
{
    ...
    /**
     * Clone Entity:: Attributes[]|Associations|Forms:: Fieldsets... || Generate Handles
     * @param Entity $entity
     * @return Entity
     */
    public function duplicateObject(Entity $entity)
    {
        ...
        foreach ($entity->getAttributes() as $attribute) {
             ...
             * @var $attribute ExpressKey
             */
            $duplicatedKey = clone $attribute;
            if (method_exists($duplicatedKey->getController(), 'duplicateKey')) {
                $attribute->getController()->duplicateKey($duplicatedKey);
            }
