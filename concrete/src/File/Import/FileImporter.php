...
class FileImporter
{
    ...
    protected function save(ImportingFile $importingFile, ImportOptions $options)
    {
        ...
        @fclose($src);
        if ($writeError !== null) {
            throw ImportException::fromErrorCode($prefixIsAutoGenerated ? ImportException::E_FILE_UNABLE_TO_STORE : ImportException::E_FILE_UNABLE_TO_STORE_PREFIX_PROVIDED);
        }
