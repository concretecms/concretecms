        ...
        if (!isset($this->localizedStatesProvinces[$locale])) {
            $provinces = [
                ...
                'GB' => [
                    ...
                    'ANTR' =>tc('Irish County', 'AntrimNorthern'),
                    'ARMA' =>tc('Irish County', 'ArmaghNorthern'),
                    'DOWN' =>tc('Irish County', 'DownNorthern'),
                    'FERM' =>tc('Irish County', 'FermanaghNorthern'),
                    'LONDD' =>tc('Irish County', 'LondonderryNorthern'),
                    'TYRO' =>tc('Irish County', 'TyroneNorthern'),
                ],
