<?php
namespace Concrete\Core\Updater\Announcement\Announcement;

use Concrete\Core\Application\UserInterface\Welcome\ContentItem\Action\Button\LearnMoreButton;
...
use Concrete\Core\Application\UserInterface\Welcome\ContentItem\Icon\SvgIcon;
use Concrete\Core\Application\UserInterface\Welcome\ContentItem\StandardItem;
use Concrete\Core\Application\UserInterface\Welcome\Modal\Slide\Slide;
use Concrete\Core\Updater\Announcement\AnnouncementInterface;
use Concrete\Core\Updater\Announcement\Slide\AnnouncementSlide;

class Version920 implements AnnouncementInterface
{

    public function getSlides(): array
    {
        return [
            new AnnouncementSlide(
