...
<div class="ccm-ui">
    ...
    <div class="dialog-buttons">
        <button class="pull-left btn btn-default" onclick="jQuery.fn.dialog.closeTop()"><?=t('Close')?></button>
        <a href="<?=URL::to('/dashboard/users/search/view', $user->getUserID())?>" class="btn btn-primary pull-right"><?=t('Edit')?></a>
    </div>
</div><!-- // div ccm-ui end -->