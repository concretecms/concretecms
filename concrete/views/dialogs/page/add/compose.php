    ...
    <form data-dialog-form="add-page-compose" action="<?=$controller->action('submit')?>">
        ...
        <div class="dialog-buttons">
            ...
            <div class="btn-group pull-right">
                <button type="button" data-composer-dialog-action="publish" value="publish" class="btn btn-primary"><?=t('Publish Page')?>
                <button style="padding-right: 5px; padding-left: 5px;" data-page-type-composer-form-btn="schedule" type="button" class="btn btn-primary">
