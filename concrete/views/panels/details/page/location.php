        ...
        <div class="col-sm-10">
            <form method="post" action="<?=$controller->action('submit')?>" data-dialog-form="location" data-panel-detail-form="location">
                ...
                if ($c->isGeneratedCollection() || $c->isPageDraft()) {
                    ...
                    <button class="btn btn-secondary float-right" type="button" data-action="add-url"><?=t('Add URL')?></button>
		...
		<td>
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <span class="input-group-text border-left-0  <% if (isAutoGenerated) { %>disabled<% } %>">
