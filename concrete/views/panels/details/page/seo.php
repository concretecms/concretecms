...
<div class="row">
    <section class="ccm-ui col-sm-9">
        ...
        <form method="post" action="<?=$controller->action('submit')?>" class="pt-4 ccm-panel-detail-content-form" data-dialog-form="seo" data-panel-detail-form="seo" data-action-after-save="reload">
            ...
            ?>
            <div class="form-group">
                <label class="control-label launch-tooltip" data-bs-placement="bottom" title="<?=t('This page must always be available from at least one URL. This is that URL.')?>" class="launch-tooltip"><?=t('URL Slug')?></label>
                <div>
