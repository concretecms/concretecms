...
class PasswordRequirements extends DashboardPageController
{
    ...
    public function view()
    {
        ...
        $this->set('specialChars', (int) max(0, array_get($config, 'required_special_characters', 0)));
    ...
    public function save()
    {
        ...
        $config->save($prefix . '.required_special_characters', $this->int($args, 'specialChars'));
