...
{
    protected function normalizeSmtpEncryption($value): string
    {
    ...
    public function save_settings()
    {
        if ($this->token->validate('save_settings')) {
            ...
            if ($this->post('MAIL_SEND_METHOD') == 'SMTP') {
                ...
                $config->save('concrete.mail.methods.smtp.encryption', $this->normalizeSmtpEncryption($this->post('MAIL_SEND_METHOD_SMTP_ENCRYPTION')));
