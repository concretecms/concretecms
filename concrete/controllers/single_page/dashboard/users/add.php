...
class Add extends DashboardPageController
{
    ...
    public function submit()
    {
        ...
        if (!$this->error->has()) {
            // do the registration
            $data = ['uName' => $username, 'uPassword' => $password, 'uEmail' => $_POST['uEmail'], 'uDefaultLanguage' => $_POST['uDefaultLanguage'] ?? null, 'uHomeFileManagerFolderID' => ($_POST['uHomeFileManagerFolderID'] == 0 ? '' : $_POST['uHomeFileManagerFolderID'])];
