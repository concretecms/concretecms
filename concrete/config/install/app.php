...
return [
    'routes' => [
        ...
        '/install/web_precondition/{handle}/{prefix}' => ['\Concrete\Controller\Install::web_precondition'],
        '/install/web_precondition/{handle}/{prefix}/{argument}' => ['\Concrete\Controller\Install::web_precondition'],
