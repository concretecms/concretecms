...
<form method="post" id="mail-importer-form" action="<?=$view->url('/dashboard/system/mail/importers', 'save_importer')?>">
    <div class="row">
        <div class="col-md-6">
            ...
            <fieldset>
                <legend><?=t($mi->getMailImporterName())?> <?=t('Settings');
    ?></legend>
...
<?php 
    ...
    ?>
		<tr>
			...
			<td width="60"><?php
                echo $ih->button(t('Edit'), $view->url('/dashboard/system/mail/importers', 'edit_importer', $mi->getMailImporterID()), 'left', 'btn-xs');
    ?></td>
		</tr>
	<?php 
}
