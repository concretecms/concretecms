    ...
    <div class="row">
        <div class="col-md-6">
            ...
            if (!Config::get('concrete.email.enabled')) {
                ?><div class="alert alert-info"><?php echo t(/*i18n: %1$s is a configuration name, %2$s is a configuration value*/'It\'s not possible to test the settings since the mail system is disabled (the setting %1$s is set to %2$s in the configuration).', '<b>concrete.email.enabled</b>', '<b>false</b>');
                ?></div><?php
