...
if (isset($activate_confirm)) {
    ...
    <div class="ccm-dashboard-form-actions-wrapper">
        <div class="ccm-dashboard-form-actions">
            ...
            <?=$ih->button(t('Cancel'), $view->url('/dashboard/pages/themes/'), 'left'); ?>
        </div>
    </div>
    <?php
} else {
                    ...
                    <td width="100%" style="vertical-align:middle;">
                        ...
                        <div class="ccm-themes-button-row clearfix"><?php
                            if (strlen($t->error) > 0) {
                                ...
                                echo $ih->button(t('Install'), $view->url('/dashboard/pages/themes', 'install', $t->getThemeHandle()), 'left', 'btn-secondary');
                            } ?></div>
                    </td>
                </tr>
            <?php
