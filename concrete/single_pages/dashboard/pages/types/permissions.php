...
<?=Loader::helper('validation/token')->output('save_permissions'); ?>
    ...
    <fieldset>
        ...
        <?php Loader::element('permission/lists/page_type', [
            'pagetype' => $pagetype,
        ]); ?>
    </fieldset>
    ...
    <fieldset>
        ...
        <?php if (Config::get('concrete.permissions.model') == 'advanced') {
            ?>
            <?php Loader::element('permission/lists/page', [
                'page' => $defaultPage,
    ...
    <div class="ccm-dashboard-form-actions-wrapper">
        <div class="ccm-dashboard-form-actions">
            <a href="<?=$view->url('/dashboard/pages/types'); ?>" class="btn btn-secondary"><?=t('Back'); ?></a>
            <button type="submit" value="<?=t('Save'); ?>" class="btn btn-primary float-right"><?=t('Save'); ?> <i class="icon-ok-sign icon-white"></i></button>
        </div>
    </div>
</form>
