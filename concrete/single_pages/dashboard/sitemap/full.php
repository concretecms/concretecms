...
<div class="ccm-dashboard-header-buttons btn-group">
    ...
    <ul class="dropdown-menu">
        <?php if ($includeSystemPages) { ?>
            <li><a class="dropdown-item" href="<?=$view->action('include_system_pages', 0)?>"><span class="text-success"><i class="fa fa-check"></i> <?=t('Include System Pages in Sitemap')?></span></a></li>
        <?php } else { ?>
            <li><a class="dropdown-item" href="<?=$view->action('include_system_pages', 1)?>"><?=t('Include System Pages in Sitemap')?></a></li>
        <?php } ?>


        <?php if ($displayDoubleSitemap) { ?>
            <li><a class="dropdown-item" href="<?=$view->action('display_double_sitemap', 0)?>"><span class="text-success"><i class="fa fa-check"></i> <?=t('View 2-Up Sitemap')?></span></a></li>
        <?php } else { ?>
            <li><a class="dropdown-item" href="<?=$view->action('display_double_sitemap', 1)?>"><?=t('View 2-Up Sitemap')?></a></li>
        <?php } ?>
    </ul>
</div>
