...
<form method="post" class="ccm-dashboard-content-form" action="<?=$view->action('create', $user->getUserID())?>">
    ...
    <div class="ccm-dashboard-form-actions-wrapper">
        <div class="ccm-dashboard-form-actions">
            <a href="<?=URL::to('/dashboard/users/search', $user->getUserID())?>" class="pull-left btn btn-default"><?=t('Cancel')?></a>
