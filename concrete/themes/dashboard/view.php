...
<header class="ccm-dashboard-page-header">
    <?php if (isset($_bookmarked)) { ?>
        <a href="#" class="ccm-dashboard-page-header-bookmark" data-page-id="<?= $c->getCollectionID(); ?>" data-token="<?=$token->generate('access_bookmarks'); ?>" data-bookmark-action="<?= $_bookmarked ? 'remove-favorite' : 'add-favorite'; ?>">
