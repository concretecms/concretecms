    ...
    <?php
      ...
      ?>
        <div class="accordion-item">
            ...
            <button class="accordion-button btn btn-outline-secondary d-sm-none <?php if($entryClass !== ' show'){echo 'collapsed'; }?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?=$entry->getId()?>">
