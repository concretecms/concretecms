...
if (isset($do_search) && $do_search) { ?>
    ...
    <?php if (count($results) == 0) {
        ...
        foreach ($results as $r) {
            ...
            $thumbnail = $r->getAttribute('thumbnail');
            ?>
            
            <div class="searchResult d-flex">
                <? if (!empty($thumbnail)) { ?>
                    <div class="searchResult-thumbnail">
                        <a href="<?= $r->getCollectionLink() ?>"><img src="<?=$thumbnail->getThumbnailURL('blog_entry_thumbnail')?>" class="img-fluid" /></a>
