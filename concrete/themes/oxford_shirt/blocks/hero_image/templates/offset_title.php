...
?>
<div data-transparency="element" class="ccm-block-hero-image offset-title" <?php if ($height) { ?>style="min-height: <?=$height?>vh"<?php } ?>>
    ...
    <div class="ccm-block-hero-image-offset-text">
