            ...
            <div class="row">
                ...
                if ($show_graph) {
                    ...
                    <div class="col-sm-12">
                        <img
                                border=""
                                src="//chart.apis.google.com/chart?cht=bhg:nda&chf=bg,s,FFFFFF00|b0,lg,270,42AAB8,0,8B455F,0.5,C82D35,1&chbh=15,4,15&chxt=y&chd=t:<?= implode(',',$optionResults) ?>&chs=1000x180&chco=<?= implode(',',$graphColors) ?>"
                ...
                ?>
                        <div class="help-block subtitle-big">
                            <?= t2('Total Votes: %d', 'Total Votes: %d', (int) $totalVotes, (int) $totalVotes) ?>
                        </div>
                    </div>
                </div>
